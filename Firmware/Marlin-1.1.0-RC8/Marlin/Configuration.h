...
#define STRING_CONFIG_H_AUTHOR "(Nate, ABL1E)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Old Grey Beard"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.316*2,87.518*2,1074.80*2,79.5611*2 }
...
#define Z_SERVO_ANGLES {65,165} // Z Servo Deploy and Stow angles
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -9.55   // Z offset: -below +above  [the nozzle]
